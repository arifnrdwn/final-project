...
module.exports = ({ data, user, sharedNotes }) => {
  return layout({
    ...
    <div style="display:flex; flex-direction:row; align-items:center; justify-content:space-between">
      ...
      <div style="display:flex; flex-direction:row; align-items:center;"><button style="background-color: #f44336; border: none; border-radius: 4px; cursor: pointer; padding: 10px"><a href='/logout'  style="text-decoration:none; color: white">Sign out  <img src="https://img.icons8.com/pastel-glyph/64/null/login-rounded-right.png"  style="width: 15px; height: 15px; margin-left:5px"/></a></button></div>
    </div>
       <div>
       <div><button class="button"><a href="/create-notes" style="text-decoration:none; color: white">Create a new note <img src="https://img.icons8.com/fluency-systems-regular/48/null/pencil--v1.png" style="width: 15px; height: 15px"/></a></button></div>
       <div>
            <h3>My Notes</h3>
              <div>
                ${showData(data)}
